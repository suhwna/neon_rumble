...
ASSETS = {
    ...
    ROOT / "assets/prototype/fighters/blaze/head.png": (384, 384),
    ROOT / "assets/prototype/fighters/bolt/head.png": (384, 384),
    ROOT / "assets/prototype/fighters/nova/head.png": (384, 384),
